...
export default function VolumeSummaryPage() {
  ...
  const handleUpload = async () => {
    if (!selectedFile) {
      notify("warning", "Select a CSV/XLSX file first.");
      return;
    }
    setLoading(true);
    try {
  ...
  const handleSaveSmoothed = () => {
    ...
    if (prophetTable.length) {
      const norm2 = buildNorm2Pivot(source);
      setProphetNorm2(norm2);
      saveForecastStore({
        prophet: {
          ...(prophetResult || {}),
          results: { ...(prophetResult?.results || {}), norm2, prophet_table: source }
        }
      });
    }
      ...
      <div className="forecast-page forecast-volume-page">
        ...
        <div className="forecast-upload-row">
          ...
          <div
            ...
            tabIndex={0}
          >
            Drag & drop or <strong>select a CSV/XLSX file</strong>
            <input
              ref={fileInputRef}
        ...
        {!hasVolumeSummary ? (
          ...
          <>
            <section className="forecast-section-block">
              ...
              {previewRows.length ? (
                <DataTable data={previewRows} maxRows={8} />
              ) : (
          ...
          <>
            <section className="forecast-section-block">
              ...
              {prophetTable.length ? (
                ...
                <DataTable data={prophetResult.results.prophet_table} maxRows={12} />
              ) : (
                <div className="forecast-placeholder-bar" />
              )}
        ...
        {hasPhase1Stage ? (
          <>
            <section className="forecast-section-block">
              ...
              {phase1Result?.results?.combined?.length ? (
                <DataTable data={phase1Result.results.combined} maxRows={12} />
              ) : (
                <div className="forecast-placeholder-bar" />
              )}
            </section>
            ...
            <section className="forecast-section-block">
              ...
              {phase1ConfigRows.length ? (
                <DataTable data={phase1ConfigRows} maxRows={12} />
              ) : (
        ...
        {hasPhase2Stage ? (
          <>
            <section className="forecast-section-block">
              ...
              {phase2Result?.results?.combined?.length ? (
                <DataTable data={phase2Result.results.combined} maxRows={12} />
              ) : (
                <div className="forecast-placeholder-bar" />
              )}
            </section>
            ...
            <section className="forecast-section-block">
              ...
              {phase2Result?.results?.base?.length ? (
                <DataTable data={phase2Result.results.base} maxRows={12} />
              ) : (
                <div className="forecast-placeholder-bar" />
              )}
            </section>
          ...
          <>
            <section className="forecast-section-block">
              ...
              {adjustedResult?.results?.adjusted?.length ? (
                <DataTable data={adjustedResult.results.adjusted} maxRows={12} />
              ) : (
                <div className="forecast-placeholder-bar" />
              )}
            </section>
            ...
            <section className="forecast-section-block">
              ...
              {adjustedResult?.results?.verify?.length ? (
                <DataTable data={adjustedResult.results.verify} maxRows={8} />
              ) : (
                <div className="forecast-placeholder-bar" />
              )}
            </section>
