    ...
    <AppShell crumbs="CAP-CONNECT / Forecast / Transformation Projects">
      <div className="forecast-page forecast-volume-page">
        ...
        {dataLoaded ? (
          ...
          {rawData.length ? <DataTable data={rawData} maxRows={10} /> : <div className="forecast-placeholder-bar" />}
        </section>
        ) : null}
        ...
        {selectionApplied ? (
          ...
          {filteredData.length ? (
            <DataTable data={filteredData} maxRows={10} />
          ) : (
        ...
        {transformApplied && transformResult ? (
          ...
          {transformResult?.results?.final?.length ? (
            <DataTable data={transformResult.results.final} maxRows={10} />
          ) : (
            <div className="forecast-placeholder-bar" />
          )}
        </section>
